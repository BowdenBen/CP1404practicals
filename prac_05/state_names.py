...
print(CODE_TO_NAME)
for state_code, state_name in CODE_TO_NAME.items():  # loop prints all the states + names
...
while state_code != "":  # while state code doesn't equal nothing, allows to quit out of loop by hitting return
    try:
        print(state_code, "is",
              CODE_TO_NAME[state_code])  # as long as the key on the list is entered, print  "key" is "key value"
